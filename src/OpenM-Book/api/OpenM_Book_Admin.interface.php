...
interface OpenM_Book_Admin extends OpenM_Book_Const {
    ...
    const RETURN_CONTAINS_ONLY_ONE_COMMUNITY_PARAMETER = "OOC";
    const RETURN_USER_CAN_REGISTER_PARAMETER = "UCAC";
    ...
    const USER_CAN_REGISTER_PARAMETER = self::RETURN_USER_CAN_REGISTER_PARAMETER;
    const CONTAINS_ONLY_ONE_COMMUNITY_PARAMETER = self::RETURN_CONTAINS_ONLY_ONE_COMMUNITY_PARAMETER;
    const USER_CAN_ADD_COMMUNITY_PARAMETER = self::RETURN_USER_CAN_ADD_COMMUNITY_PARAMETER;
    const VALIDATION_REQUIRED_PARAMETER = self::RETURN_VALIDATION_REQUIRED_PARAMETER;
